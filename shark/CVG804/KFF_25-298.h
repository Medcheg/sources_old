...
#define FILENAME2 "FIR_P_5823_70_100.dat";   // ----- Имя файла полосового фильтра
#define TAPSS 70  // ----- длина полосового фильтра

// *** Контур стабилизации амплитуды пучности
	// --- Первый регулятор ----
#define KP21 35.0 //16.0  5 Hz
#define KI21  3.5 //2.0
	// --- Второй регулятор ----
#define KP22 1.0
#define KI22 0.1 //0.1   
...
// *** Контур компенсации синфазной составляющей
	// --- Первый регулятор ----
#define KP41 35.0 //30.0  5 Hz
#define KI41  3.5 //10.0
	// --- Второй регулятор ----
#define KP42 1.0
...
// =====================
// =====================
#define N_exc    8.174818039
#define N_comp   4.890179954
#define T_base  17.14692879
// =====================
// =====================
#define k_omega   1.0   // ---- Знак угловой скорости ----
#define SMM2     -1.70  // ---- Заданная амплитуда пучности ----
