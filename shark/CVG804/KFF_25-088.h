...
/**********************************************
 *             Гироскоп № 25-088    (1-5)     *
 *   Резонансная частота - 4300 Hz; Q - xxxxx *
 *         Дата настройки 27.02.09            *
 *			M = x.xxxxx  FIkom = x.xxxx       *
 **********************************************/
...
#define FILENAME2 "FIR_P_4305_94_100.dat";   // ----- Имя файла полосового фильтра
...
// *** Контур компенсации квадратурной составляющей
	// --- Первый регулятор ----
#define KP41 30.0 //30.0  5 Hz
#define KI41 10.5 //10.0
	// --- Второй регулятор ----
#define KP42 1.0
#define KI42 0.06 //0.07
...
// =====================
// =====================
#define N_exc  13.832891
#define N_comp  7.943137574
#define T_base 23.251722
