...
// DEBUG_MODE 5 ----- АЧХ возбуждения Автогенератора (Резонансная фаза) -----
// DEBUG_MODE 6 ----- АЧХ возбуждения Канала Х (Резонансная фаза) -----
// DEBUG_MODE 7 ----- АЧХ возбуждения Канала У (Резонансная фаза) -----

  #define DEBUG_MODE       0
  #define DEBUG_PARAM_FREQ 2000
  #define TIMES            40 //  sec // --- Время прыжка 
 
// =====================
// =====================
#define Base_Frequency        4235.958
#define PHASE_AG              32.3326
#define PHASE_EXCITIATION_X   58.436
#define PHASE_EXCITIATION_Y   62.127

// =====================
// =====================
#define k_omega  -1.0    // ---- Знак угловой скорости ----
#define X_ampl   1.0     // ---- Заданная амплитуда колебаний канала X
#define Y_ampl   1.0     // ---- Заданная амплитуда колебаний канала X
...
#define GYRO_StartUp_Time 0.5

// Коэфф регулятора контура ВОЗБУЖДЕНИЯ канала X
        #define Kp_x   9.0 
        #define Ki_x   2.0

// Коэфф регулятора контура ВОЗБУЖДЕНИЯ канала Y
        #define Kp_y   9.0    
        #define Ki_y   2.0

// Коэфф регулятора контура ФАЗЫ
        #define Kp_phi  2.0  
        #define Ki_phi  1.1
