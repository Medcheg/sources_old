...
// =====================
// =====================
#define Base_Frequency      5799.958
#define PHASE_AG            26.5326
#define PHASE_EXCITIATION   83.527
#define PHASE_COMPENSATION  83.527
...
// Коэфф регулятора контура КОРИОЛИСА  ---- 50hz
        #define Kp_c1   192.0    
        #define Ki_c1   95.5
