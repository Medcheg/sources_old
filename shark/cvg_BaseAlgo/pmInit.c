...
void Init_UART_Param( TGyro *gyro )
{
    ...
    gyro->UART_Param[11] = &gyro->in_Kx;//gyro->XInputMean.GlobalMean;   //  Среднее значение Х
    gyro->UART_Param[12] = &gyro->YInputMean.GlobalMean;   // Среднее значение Y
    ...
    gyro->UART_Param[15] = &gyro->Zn_sin2.zn_curr;           // Косинус в Тактах алгоритма 
    gyro->UART_Param[16] = &gyro->pi_am_1.m_const;//gyro->Zn_cos1.zn_curr;           // Косинус в Тактах алгоритма 
