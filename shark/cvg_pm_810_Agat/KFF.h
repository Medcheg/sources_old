...
// ======================================
  ...
  #define CORR_Y_PHASE          0//1

  #define CORR_ALFA_E_f         0
  #define CORR_ALFA_Q_f         0
  
  #define CORR_ALFA_E_t         0//1
  #define CORR_ALFA_Q_t         0//1
  
  #define CORR_DELTA_PHI        0
...
// =====================
// =====================
#define Base_Frequency      2674.958
#define PHASE_AG            54.3326
#define PHASE_EXCITIATION   41.45722
#define PHASE_COMPENSATION  40.07124
#define PHASE_DELTA_PHI     0.0

// =====================
// =====================
#define k_omega  -1.0    // ---- Знак угловой скорости ----
#define X_ampl   1.02     // ---- Заданная амплитуда колебаний канала X
...
// ********** Phase compensation ****************
// **********************************************
    #define corr_y_ph_a0  7.1283871E-03   //^0
    #define corr_y_ph_a1  -2.5625378E-04  //^1
    #define corr_y_ph_a2  -1.2984725E-06  //^2
...
// **********************************************************************
    ...
    #define corr_e_t0   -7.21425330266E-03    //^0
    #define corr_e_t1    8.96975052456E-06   //^1
    #define corr_e_t2   -2.02122296677E-09   //^2
...
// **********************************************************************
    ...
    #define corr_q_t0    7.13107828051E-03  //^0
    #define corr_q_t1   -2.55917053437E-04  //^1
    #define corr_q_t2   -1.29840793761E-06  //^2
