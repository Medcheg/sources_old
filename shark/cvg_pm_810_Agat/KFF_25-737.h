...
#define KFFH
 /*********************************************
 *               Гироскоп № 25_737            *
 *      Резонансная частота 4549.728 Гц       *
 *              Дата настройки 03.02.10       *
 **********************************************/ 
...
// =====================
// =====================
#define Base_Frequency      4548.59
#define PHASE_AG            27.46
#define PHASE_EXCITIATION   64.24
#define PHASE_COMPENSATION  64.27522
#define PHASE_PHIQ          0.0

// =====================
// =====================
#define k_omega  1.0   // ---- Знак угловой скорости ----
#define X_ampl   0.82  // ---- Заданная амплитуда колебаний канала X
...
#define coef_N   0.02027986;//коэффициент канала узла

#define GYRO_StartUp_Time 0.2

// Коэфф регулятора контура ВОЗБУЖДЕНИЯ  ---- 12hz
        #define Kp_x1  8.5 
        #define Ki_x1  1.8

// Коэфф регулятора контура КОРИОЛИСА  ---- 100hz
        #define Kp_c1  324.0    
        #define Ki_c1   82.0
        //#define Kp_c1  24.0    
        //#define Ki_c1  22.0
...
// Коэфф регулятора контура КВАДРАТУРЫ  ---- 10hz
    ...
    // Коэфф регулятора контура ЧАСТОТЫ  ---- 10hz
        #define Kp_f1  4.99
        #define Ki_f1  1.6
//*****************************************
//*************  Коррекции    *************
