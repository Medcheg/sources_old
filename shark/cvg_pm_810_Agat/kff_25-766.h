...
#define KFFH
 /*********************************************
 *               Гироскоп № 25-766c           *
 *      Резонансная частота 5718.129 Гц       *
 * M=0,036      Дата настройки 23.03.10       *
 **********************************************/ 
...
// =====================
// =====================
#define Base_Frequency    5718.400
#define PHASE_AG            28.753
#define PHASE_EXCITIATION   81.185
#define PHASE_COMPENSATION  81.185
...
// Коэфф регулятора контура КОРИОЛИСА  ---- 30hz
        #define Kp_c1  350.0    
        #define Ki_c1  163.0

// Коэфф регулятора контура КВАДРАТУРЫ  ---- 6hz
        #define Kp_q1   7.0  
        #define Ki_q1   1.8
