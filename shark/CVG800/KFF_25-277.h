...
// *** Контур стабилизации амплитуды пучности ***
	// --- Первый регулятор ----
	#define KP21 23.5 //160.0 50hz//70.0 20Hz//22.0  5 Hz
	#define KI21  5.0 // 25.0     //12.0     // 3.0
	// --- Второй регулятор ----
	#define KP22 1.0
...
// *** Контур компенсации квадратурной составляющей ***
	// --- Первый регулятор ----
	#define KP41 120.0 //250.0 100hz//170.0 60Hz//120.0 50Hz //110.0 40Hz//50.0  20Hz//19.0 5Hz
	#define KI41  12.5 // 28.0      // 15.0     //  12.5     //13.0      // 7.5      // 3.0
	// --- Второй регулятор ----
	#define KP42 1.0
...
// =====================
// =====================
#define N_exc    11.627831//23.29//15.473//21.615
#define N_comp   6.143834105//13.83345062//9.385425621//13.29
#define T_base   22.84310150//37.0507125854
