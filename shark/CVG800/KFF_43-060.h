...
#define FILENAME2 "FIR_P_2135_94_100.dat";   // ----- Имя файла полосового фильтра
#define TAPSS 94   // ----- длина полосового фильтра

// *** Контур стабилизации амплитуды пучности ***
	// --- Первый регулятор ----
	#define KP21 22.0 //160.0 50hz//70.0 20Hz//22.0  5 Hz
	#define KI21  3.0 // 25.0     //12.0     // 3.0
	// --- Второй регулятор ----
	#define KP22 1.0
	#define KI22 0.02//0.1   

// *** Контур компенсации кориолисовой составляющей ***
	// --- Первый регулятор ----
	#define KP31  140.0 //250.0 100hz //140.0 50Hz
	#define KI31   40.0 // 52.0       // 40.0
	// --- Второй регулятор ----
	#define KP32 1.0
	#define KI32 0.1//
...
// *** Контур компенсации квадратурной составляющей ***
	// --- Первый регулятор ----
	#define KP41  110.0 //250.0 100hz//170.0 60Hz//120.0 50Hz //110.0 40Hz//50.0  20Hz//19.0 5Hz
	#define KI41   13.5 // 28.0      // 15.0     //  12.5     //13.0      // 7.5      // 3.0
	// --- Второй регулятор ----
	#define KP42 1.0
...
// =====================
// =====================
#define N_exc    13.98458    //23.29//15.473//21.615
#define N_comp   7.993759878 //13.83345062//9.385425621//13.29
#define T_base   23.58552   //37.0507125854
