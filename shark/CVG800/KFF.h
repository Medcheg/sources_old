/**********************************************
 *               Гироскоп № 43-060            *
 *      Резонансная частота  2425.391483      *
 *              Дата настройки                *
 **********************************************/ 
...
#define FILENAME2 "FIR_P_2425_84_100.dat";   // ----- Имя файла полосового фильтра
#define TAPSS 84   // ----- длина полосового фильтра

// *** Контур стабилизации амплитуды пучности ***
	// --- Первый регулятор ----
	#define KP21 25.0 //160.0 50hz//70.0 20Hz//22.0  5 Hz
	#define KI21  4.0 // 25.0     //12.0     // 3.0
	// --- Второй регулятор ----
	#define KP22 1.0
	#define KI22 0.1//0.1   
...
// *** Контур компенсации кориолисовой составляющей ***
	// --- Первый регулятор ----
	#define KP31   30.0 //250.0 100hz //140.0 50Hz
	#define KI31    4.0 // 52.0       // 40.0
	// --- Второй регулятор ----
	#define KP32 1.0
	#define KI32 0.1//
...
// *** Контур компенсации квадратурной составляющей ***
	// --- Первый регулятор ----
	#define KP41  17.0 //250.0 100hz//170.0 60Hz//120.0 50Hz //110.0 40Hz//50.0  20Hz//19.0 5Hz
	#define KI41   3.0 // 28.0      // 15.0     //  12.5     //13.0      // 7.5      // 3.0
	// --- Второй регулятор ----
	#define KP42 1.0
...
// =====================
#define N_exc  20.09
#define N_comp 16.17868557

#define T_base 41.198566
...
#define SMM2    -4.0   // ---- Заданная амплитуда пучности ----
