...
#define KFFH
 /*********************************************
 *               Гироскоп № 25_830b           *
 *      Резонансная частота 5126.97 Гц        *
 * M=0.022      Дата настройки 31.03.10       *
 **********************************************/ 
...
// DEBUG_MODE 7 ----- АЧХ возбуждения (Резонансная фаза) -----
  ...
  #define TIMES                 35 //  sec // --- Время прыжка 

// =====================
// =====================
#define Base_Frequency    5127.448
#define PHASE_AG            17.540
#define PHASE_EXCITIATION   73.671
#define PHASE_COMPENSATION  73.247510
...
#define coef_AN  0.859      //коэффициент канала пучности
#define coef_N   0.0082711 //коэффициент канала узла

#define GYRO_StartUp_Time 0.2

// 1 --- Коэфф регулятора контура ВОЗБУЖДЕНИЯ  ---- 10hz
        #define Kp_x1   2.6 
        #define Ki_x1   2.3

// 2 --- Коэфф регулятора контура КОРИОЛИСА  ---- 17hz
        #define Kp_c1   95.0    
        #define Ki_c1   48.5

// 3 --- Коэфф регулятора контура КВАДРАТУРЫ  ---- 12hz
        #define Kp_q1   4.2  
        #define Ki_q1   3.45
