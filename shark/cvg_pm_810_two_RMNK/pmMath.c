...
//
// *****************************************************************
void Run_Demod_RMNK( TRMNK *prmnk, float inX, float inY  )
{
    float  HQx, HQy;
    float  xa2, xb2;
    float  k = 10000.0;
   ...
   // --------------------------------------------
        ...
        prmnk->Qy[0] = prmnk->Qy[0] - prmnk->MjuY[0]                     * HQy;
        prmnk->Qy[1] = prmnk->Qy[1] - prmnk->MjuY[1] * prmnk->x_base_sin * HQy;
        prmnk->Qy[2] = prmnk->Qy[2] - prmnk->MjuY[2] * prmnk->x_base_cos * HQy;
   ...
   // ------ фильтрование -----
        ...
        //Run_LowPass_IRFiltr_1rstOrder( prmnk->fi_Ya,  prmnk->Qy[1] );  
        //Run_LowPass_IRFiltr_1rstOrder( prmnk->fi_Yb,  prmnk->Qy[2] );

        prmnk->fi_Xa[0] = prmnk->Qx[1]*prmnk->Qx[1] + prmnk->Qx[2]*prmnk->Qx[2];
        prmnk->fi_Xb[0] = prmnk->Qx[2];
        prmnk->fi_Ya[0] = prmnk->Qy[1];
        prmnk->fi_Yb[0] = prmnk->Qy[2];
        ...
        prmnk->YAmpl = sqrtf(pm_sqr(prmnk->Qy[1]) + pm_sqr(prmnk->Qy[2]));
}
