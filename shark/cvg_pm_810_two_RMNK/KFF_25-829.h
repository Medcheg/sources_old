...
#define KFFH
 /*********************************************
 *               Гироскоп № 25_829a           *
 *      Резонансная частота 4459.55 Гц        *
 * M=0.0147      Дата настройки 30.03.10       *
 **********************************************/ 
...
// =====================
// =====================
#define Base_Frequency    4459.642
#define PHASE_AG            27.906
#define PHASE_EXCITIATION   63.76
#define PHASE_COMPENSATION  63.46
...
// 2 ---- Коэфф регулятора контура КОРИОЛИСА  ---- 15hz
        #define Kp_c1   100.2   
        #define Ki_c1   22.0
        //#define Kp_c1   11.2   
        //#define Ki_c1   5.0
