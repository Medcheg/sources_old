...
#define X_ampl   (float)1.7    // ---- Заданная амплитуда колебаний канала X ----
...
// =====================
    ...
    // --- Регуляторы контура ВОЗБУЖДЕНИЯ  ----  12Hz
    ...
    // --- Регуляторы контура КОРИОЛИСА  ---- 50 Hz (0.707 = 100 Hz)
    ...
    // --- Регуляторы контура КВАДРАТУРЫ  ---- 13.Hz
