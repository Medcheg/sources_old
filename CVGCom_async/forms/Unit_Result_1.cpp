...
#pragma resource "*.dfm"
Tform_Result_1 *form_Result_1;

//===========================================================================
__fastcall Tform_Result_1::Tform_Result_1(TComponent* AOwner)
	: TForm(AOwner)
{
    pStorage                   = NULL;
...
//===========================================================================
void __fastcall Tform_Result_1::FormShow(TObject *Sender)
{
...
//===========================================================================
void Tform_Result_1::SetupForms( CCollectionStorage<float> *apStorage, TSelectPart *apSelecetStorageParts, bool *apisSelecetStorageParts, int *apCountSelectedStorageParts )
{
   // -----
    pStorage                   = apStorage;
...
//===========================================================================
void Tform_Result_1::SetupTableValues(int aIndex)
{
...
//===========================================================================
void __fastcall Tform_Result_1::TabControl1Change(TObject *Sender)
{
    SetupTableValues(TabControl1->TabIndex);
}

//===========================================================================
void __fastcall Tform_Result_1::SpeedButton1Click(TObject *Sender)
{
    try {
...
//===========================================================================
void __fastcall Tform_Result_1::Button1Click(TObject *Sender)
{
...
//===========================================================================
void __fastcall Tform_Result_1::Button2Click(TObject *Sender)
{
    if ( pStorage == NULL ) return;
    if ( pSelecetStorageParts == NULL ) return;
   // -------------
    Tform_Result_1_Report *dlg = new Tform_Result_1_Report(this);
...
//===========================================================================
void __fastcall Tform_Result_1::FormActivate(TObject *Sender)
{
    DecimalSeparator = '.';
}
...
//===========================================================================
void __fastcall Tform_Result_1::SpeedButton2Click(TObject *Sender)
{
...
//===========================================================================
void __fastcall Tform_Result_1::speedbutton_ConvertToFreqClick(TObject *Sender)
{
