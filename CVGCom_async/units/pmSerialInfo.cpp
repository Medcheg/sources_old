...
//===========================================================================
int GetPortInfo ( int nIndexFromZero, TSerialPortInfo *pPortInfoOut)
{
    // -------
	...
	while( SetupDiEnumDeviceInfo( hDevInfoSet, nIndex, &devInfo ) && ( nIndexFromZero != -1 ) )
	{
