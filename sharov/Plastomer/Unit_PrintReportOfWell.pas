unit Unit_PrintReportOfWell;

interface

uses
  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs,
  StdCtrls, Buttons, ExtCtrls, mpiDeclaration, WinSpool;
...
type
  ...
  private
    ...
    function  OutBottomCap(CurYPos : Integer; ArrayIndexPerPage, DrawedArrayIndex : Integer; MashtabCoef : Float): integer;
...
uses Printers, mpiReportClass, mpiLasFile,
  mpiPrintReportOfWell, Unit_StatAnalysis;
...
function TfrmPrintReportOfWell.OutBottomCap(CurYPos : Integer; ArrayIndexPerPage, DrawedArrayIndex : Integer; MashtabCoef : Float): integer;
var
...
begin
  ...
  if PrintDialog1.Execute then begin
            ...
            // ---------------------
            FillType_PrintParam(HeadHeight);   // --- Растановка Позиций полей ------
           // ---------------------
            ...
            if RadioGroup1.ItemIndex <> 0 then begin
                  ...
                  SetPrinterPageSizes(Printer.PageWidth, PageHeightInPixel);
                  // ---------

                  Printer.BeginDoc;
                        PrintPageReportOfWell(Printer.Canvas, MashtabCoef, 0, LasFile.XValue.Count);
                        PrintHeadPaper       (Printing);
                        OutTopCap            (0, 0, false);
                        OutBottomCap         (PrintParam.BeginY + Trunc(LasFile.XValue.Count/MashtabCoef), 0, 0, MashtabCoef);
                  Printer.EndDoc;
            end else begin
                  Printer.BeginDoc;
                        PrintHeadPaper(Printing);                                              // --- Печать титульного листа отчета                  ---
                        Printer.NewPage;
                        /////////////////////////////////////////////////////
                        //////     Постраничная печать //////////////////////
                        /////////////////////////////////////////////////////
                        ...
                        for i := 0 to PageCount - 1 do begin
                              ...
                              // ----------------------------------
                                 PrintPageReportOfWell(Printer.Canvas, MashtabCoef, BeginPageDepthIndex, EndPageDepthIndex);
                                 OutTopCap(i, RealPageCount, true);
                              // ----------------------------------
                              BeginPageDepthIndex := BeginPageDepthIndex + ArrayIndexPerPage;
                              if i <> PageCount - 1 then Printer.NewPage;
                        end;
                        OutBottomCap(-1, ArrayIndexPerPage,(EndPageDepthIndex - (BeginPageDepthIndex - ArrayIndexPerPage)), MashtabCoef);
                  Printer.EndDoc;
            end;
  end;
  Close;
