...
type
  TfrmReportOfWell1_Param = class(TForm)
    Panel1: TPanel;
...
var
  frmReportOfWell1_Param: TfrmReportOfWell1_Param;

implementation

uses mpiReportClass, mpiLibrary, Unit_ReportOfWell1,
...
procedure TfrmReportOfWell1_Param.FormShow(Sender: TObject);
begin
   DataFilling := False;
  // ----------------------------
    Caption := frmMainCaption + frmMain.aReportOfWell1.Caption + '  -  Параметры' ;
  // ----------------------------
...
procedure TfrmReportOfWell1_Param.TrackBar1Change(Sender: TObject);
begin
    ...
    frmReportOfWell1.ScrollBar1Change(Sender);
end;

{===============================================================================
}
procedure TfrmReportOfWell1_Param.Label3DblClick(Sender: TObject);
begin
...
procedure TfrmReportOfWell1_Param.BitBtn1Click(Sender: TObject);
begin
...
procedure TfrmReportOfWell1_Param.seGolovasticRadiusChange(Sender: TObject);
begin
...
procedure TfrmReportOfWell1_Param.lbSeriesClick(Sender: TObject);
var
...
procedure TfrmReportOfWell1_Param.lbSeriesDragOver(Sender, Source: TObject;
...
function TfrmReportOfWell1_Param.SeriesPresent(aName: String): boolean;
var
  i       : Integer;
  mdr     : word;
begin
...
procedure TfrmReportOfWell1_Param.lbPole1DragDrop(Sender, Source: TObject;
  X, Y: Integer);
var
  lbSource : TListBox;
  lbSender : TListBox;
...
procedure TfrmReportOfWell1_Param.lbPole1MouseDown(Sender: TObject;
...
procedure TfrmReportOfWell1_Param.lbPole1MouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
begin
...
procedure TfrmReportOfWell1_Param.lbPole1MouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
var
  i : integer;
begin
...
procedure TfrmReportOfWell1_Param.lbPole1KeyDown(Sender: TObject;
...
procedure TfrmReportOfWell1_Param.tbRemoveSeriesClick(Sender: TObject);
var
  OldIndex  : Integer;
begin
...
procedure TfrmReportOfWell1_Param.FormActivate(Sender: TObject);
begin
  DecimalSeparator    := '.';
end;
...
procedure TfrmReportOfWell1_Param.addSeriesToPoleDopCurves(Series : TSeries);
var
  AbsMaxValue : TFloat;
begin
  // ---- Добавляем серию -------
...
procedure TfrmReportOfWell1_Param.cbNominalDiametrClick(Sender: TObject);
begin
...
procedure TfrmReportOfWell1_Param.Add_Lithography_Layer(Pos: Integer);
var
...
procedure TfrmReportOfWell1_Param.tbAddLayerClick(Sender: TObject);
var
  Lithography : TLithography;
begin
  Lithography := TLithography(ReportClass.PoleList.Items[1]);
...
procedure TfrmReportOfWell1_Param.tbInsertLayerClick(Sender: TObject);
var
  Lithography : TLithography;
  i           : Integer;
begin
...
procedure TfrmReportOfWell1_Param.bApplyLayerClick(Sender: TObject);
var
  Lithography : TLithography;
begin
   Lithography := TLithography(ReportClass.PoleList.Items[1]);
...
procedure TfrmReportOfWell1_Param.PaintBox1Paint(Sender: TObject);
var
  Lithography : TLithography;
begin
  Lithography := TLithography(ReportClass.PoleList.Items[1]);
...
procedure TfrmReportOfWell1_Param.PaintBox1Click(Sender: TObject);
var
  CurPoint    : TPoint;
begin
...
procedure TfrmReportOfWell1_Param.miLayerBrushStyleClick(Sender: TObject);
var
  Lithography : TLithography;
begin
  Lithography := TLithography(ReportClass.PoleList.Items[1]);
...
procedure TfrmReportOfWell1_Param.pLayerColorClick(Sender: TObject);
var
  Lithography : TLithography;
begin
  Lithography := TLithography(ReportClass.PoleList.Items[1]);
...
procedure TfrmReportOfWell1_Param.eNameLayerChange(Sender: TObject);
var
  Lithography : TLithography;
begin
  Lithography := TLithography(ReportClass.PoleList.Items[1]);
...
procedure TfrmReportOfWell1_Param.lbLayerClick(Sender: TObject);
var
  Lithography : TLithography;
begin
  Lithography := TLithography(ReportClass.PoleList.Items[1]);
...
procedure TfrmReportOfWell1_Param.Button1Click(Sender: TObject);
var
  Lithography : TLithography;
begin
  Lithography := TLithography(ReportClass.PoleList.Items[1]);
...
procedure TfrmReportOfWell1_Param.Button2Click(Sender: TObject);
var
  Lithography : TLithography;
begin
  Lithography := TLithography(ReportClass.PoleList.Items[1]);
...
procedure TfrmReportOfWell1_Param.FormCloseQuery(Sender: TObject;
...
procedure TfrmReportOfWell1_Param.eBeginLayerDepthChange(Sender: TObject);
begin
     lbLayer.Enabled           := false;
     BitBtn1.Enabled           := false;
     BitBtn2.Enabled           := false;
...
procedure TfrmReportOfWell1_Param.PageControl1Changing(Sender: TObject;
  var AllowChange: Boolean);
begin
...
procedure TfrmReportOfWell1_Param.Add_Freq_Layer(Pos: Integer);
var
  FreqPole : TFreqPole;
begin
...
procedure TfrmReportOfWell1_Param.tbAddFreqLayerClick(Sender: TObject);
var
  FreqPole : TFreqPole;
begin
  FreqPole := TFreqPole(ReportClass.PoleList.Items[6]);
...
procedure TfrmReportOfWell1_Param.tbInsertFreqLayerClick(Sender: TObject);
var
  FreqPole : TFreqPole;
  i        : Integer;
begin
...
procedure TfrmReportOfWell1_Param.lbFreqLayerClick(Sender: TObject);
var
  FreqPole : TFreqPole;
  v1, v2, v3 : Integer;
begin
...
procedure TfrmReportOfWell1_Param.Button3Click(Sender: TObject);
var
  FreqPole : TFreqPole;
begin
  FreqPole := TFreqPole(ReportClass.PoleList.Items[6]);
...
procedure TfrmReportOfWell1_Param.FreqLayerChange(
  Sender: TObject);
var
  FreqPole : TFreqPole;
begin
...
procedure TfrmReportOfWell1_Param.ReAddAllFreqLayer();
var
  FreqPole : TFreqPole;
  i        : Integer;
begin
...
procedure TfrmReportOfWell1_Param.tbDeleteLayerClick(Sender: TObject);
var
  Lithography : TLithography;
  i           : Integer;
begin
...
procedure TfrmReportOfWell1_Param.ReAddAllLitLayer();
var
  Lithography : TLithography;
  i        : Integer;
begin
...
procedure TfrmReportOfWell1_Param.tbDeleteFreqLayerClick(Sender: TObject);
var
  FreqPole    : TFreqPole;
  i           : Integer;
begin
...
procedure TfrmReportOfWell1_Param.bbLoadLasFileClick(Sender: TObject);
var
  FileName : String;
begin
...
procedure TfrmReportOfWell1_Param.LoadGisLasFile(aFileName: String);
var
  GISPole  : TGIS;
  i        : Integer;
  Series   : TSeries;
...
procedure TfrmReportOfWell1_Param.lbGISSeriesClick(Sender: TObject);
var
  CurItemIndex : Integer;
  CurTag       : Integer;
begin
...
procedure TfrmReportOfWell1_Param.lbGISSeriesDragOver(Sender,
...
procedure TfrmReportOfWell1_Param.lbGISPoleDragDrop(Sender, Source: TObject;
  X, Y: Integer);
var
  lbSource : TListBox;
  lbSender : TListBox;
...
procedure TfrmReportOfWell1_Param.lbGISPoleDragOver(Sender, Source: TObject;
  X, Y: Integer; State: TDragState; var Accept: Boolean);
begin
  Accept := Source is TListBox;
end;
...
procedure TfrmReportOfWell1_Param.lbGISPoleKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  if TListBox(Sender).ItemIndex = -1 then exit;
...
procedure TfrmReportOfWell1_Param.tbRemoveGISSeriesClick(Sender: TObject);
var
  OldIndex  : Integer;
begin
...
procedure TfrmReportOfWell1_Param.addSeriesToGISPole(Series: TSeries);
var
  AbsMaxValue : TFloat;
begin
  // ---- Добавляем серию -------
...
procedure TfrmReportOfWell1_Param.lbGISPoleEnter(Sender: TObject);
var
  Series : TSeries;
begin
...
procedure TfrmReportOfWell1_Param.pGisSeriesCOlorClick(Sender: TObject);
var
  OldColor : TColor;
  Series : TSeries;
begin
...
procedure TfrmReportOfWell1_Param.pbGisSeriesStyleClick(Sender: TObject);
var
  CurPoint    : TPoint;
begin
...
procedure TfrmReportOfWell1_Param.seseGisSeriesWidthChange(Sender: TObject);
var
  Series : TSeries;
begin
...
procedure TfrmReportOfWell1_Param.pbGisSeriesStylePaint(Sender: TObject);
var
  Series : TSeries;
begin
  if lbGISPole.ItemIndex = - 1 then exit;
...
procedure TfrmReportOfWell1_Param.fg1Click(Sender: TObject);
var
  Series : TSeries;
begin
  Series := TSeries(TGIS(ReportClass.PoleList.Items[4]).SeriesList.Items[lbGISPole.ItemIndex]);
...
procedure TfrmReportOfWell1_Param.se1Change(Sender: TObject);
var
...
procedure TfrmReportOfWell1_Param.FormDestroy(Sender: TObject);
begin
//
end;

procedure TfrmReportOfWell1_Param.bbRemoveGISLasFileClick(Sender: TObject);
var
  GISPole  : TGIS;
begin
  GISPole := TGIS(ReportClass.PoleList.Items[4]);
