...
#include "M_ArcSinus.h"
#include "Unit_BaseDialog_01.h"
//===========================================================================
void TArcSinus_Init() { RegisterElement("DiALab - Базовые", "Тригонометрия", (int)&TArcSinus::Create); }
#pragma startup TArcSinus_Init 110 // default 100
//===========================================================================
TArcSinus::TArcSinus()
{
...
//===========================================================================
void TArcSinus::LoadFromStream(TStream *aStream) { TElement::LoadFromStream(aStream);
}

//===========================================================================
void TArcSinus::SaveToStream(TStream *aStream) { TElement::SaveToStream(aStream);
}

//===========================================================================
void TArcSinus::DrawElementFace()
{
...
//===========================================================================
void TArcSinus::Copy(void *aElement) { TElement::Copy(aElement);
}

//===========================================================================
void TArcSinus::Init() { TElement::Init();
}

//===========================================================================
void TArcSinus::InitBeforeRun()
{
...
//===========================================================================
void TArcSinus::Run() { if (!isEnabledCalc()) return; TElement::Run();
   // --------------
      oQueue[0]  =  Math::ArcTan2(iQueue[0], sqrt(fabs(1 - iQueue[0]*iQueue[0])));
//      oQueue[0] = Math::ArcSin(iQueue[0]);
   // --------------
}
