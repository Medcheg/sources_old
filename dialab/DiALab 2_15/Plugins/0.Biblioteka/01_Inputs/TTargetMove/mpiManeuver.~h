...
public:
     ...
     // ----------
         ...
         TFloat   *CurE;    // ----- Текущее значение Угла места ---------
         ...
         TFloat   *CurZ;    // ----- Текущее значения движения объекта в по координате Y (в горизонтальной плоскости) ----
...
public:
     ...
     // ----------
         ...
         TFloat   V;    // ----- Текущее значение Скорости ---------
         TFloat   Eps;  // ----- Ткущее знащение угла места -----
