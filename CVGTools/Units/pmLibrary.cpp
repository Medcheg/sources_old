...
//===========================================================================
void GetFolderList( AnsiString Directory, TStringList *DirList )
{
	TSearchRec srEntry;
    try {
...
//===========================================================================
void Draw_LineRectangle(Graphics::TCanvas *aCanvas, bool isDotLise, Graphics::TColor aColor, Types::TRect aRect)
{
...
//===========================================================================
void CopyNullTerminatedString( const char *aSource, char **aDest )
{
    if ( *aDest != NULL )
...
//===========================================================================
void Draw_ChartSeries(TChart *aChart, int SeriesIndex,
