...
void TDiagram::Init()
{
  ...
  // ------------
   ...
   DirectionalCosines.cell[1][0] = aFar->Ravnosignal_DirectionalCosines.cell[1][0] + sin(fOffsetX);
   DirectionalCosines.cell[2][0] = aFar->Ravnosignal_DirectionalCosines.cell[2][0] + sin(fOffsetY);
 ...
 // --------- Положение цели в системе координат ФАР ---------
   ...
   aFar->Calc_DeltaQ_DeltaAlfa_Teta_Fi(aQ, aE, Teta, Fi);
}
