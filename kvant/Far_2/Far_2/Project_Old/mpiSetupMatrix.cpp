...
void Calc_Matrixs(TFar *fFar)
{
  ...
  // ------------------ Ошибка измерения курса корабля    ---------------
  ...
  // ------------------ Матрица ошибки измерения килевой качки     ---------------
  ...
  // ------------------ Матрица ошибки измерения Бортовой  качки     ---------------
  ...
  // ------------------ НЕстабильность вращения анетнны ------------
  ...
  //*********************************************************************************************************************************************************************************************
  //*********************************************************************************************************************************************************************************************
  // ------------------ Матрица Утановки антенны по углу места  ------------
  ...
  // ------------------ Матрица Ошибки утановки антенны по углу места  ------------
  ...
  //*********************************************************************************************************************************************************************************************
  //*********************************************************************************************************************************************************************************************
  // ------------------ Матрица фокального разворота антенны   ------------
  ...
  // ------------------ Матрица ошибки установки фокального разворота антенны   ------------
 ...
 // ------------------- Матрица отработки килевой качки --------------
/*    TFloat Psi_otr = -Psi->Value + DeltaPsi->Value;
 ...
 // ------------------- Матрица отработки бортовой качки --------------
