...
public:
       ...
       AnsiString  ShortCaption; // ----- Краткое название качки ----
      ...
      // ------------
       ...
       void   Edit(); // ---- Диалог параметров блока -------------
        ...
        TWave (TFloat *apCurTime, TFloat *apT0, bool *apFiltrationEnabled, AnsiString aCaption, AnsiString aShortCaption, TRazmernost aRazmernost, int aTag);
        TWave (TFloat *apCurTime, TFloat *apT0, AnsiString aCaption, AnsiString aShortCaption, TRazmernost aRazmernost, int aTag);
       ~TWave ();
};
