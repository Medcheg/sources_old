...
// ========================    Constructor TWave    ============================
// =============================================================================
TWave::TWave(TFloat *apCurTime, TFloat *apT0, AnsiString aCaption, AnsiString aShortCaption, TRazmernost aRazmernost, int aTag)
{
   DecimalSeparator = '.';
  // ------------------------
   pCurTime           = apCurTime;
...
// ========================    Constructor TWave    ============================
// =============================================================================
TWave::TWave(TFloat *apCurTime, TFloat *apT0, bool *apFiltrationEnabled, AnsiString aCaption, AnsiString aShortCaption, TRazmernost aRazmernost, int aTag)
{
   DecimalSeparator = '.';
  // ------------------------
   pCurTime           = apCurTime;
