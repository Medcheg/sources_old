...
uses
  ...
  ComCtrls, Spin, ToolWin, KatalogFrm,
  AppEvnts, ActnList, Menus, Grids, TeeProcs, TeEngine;
...
type
  ...
  private
    ...
    procedure SaveGraph(Tab : TTabSheet);
...
var
  ...
  procedure ShowInterpolGraph (Tab : TTabSheet; GraphNo : integer);
...
procedure TMainForm.SaveGraph(Tab : TTabSheet);
