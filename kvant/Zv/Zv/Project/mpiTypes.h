...
typedef struct {
      ...
      TFloat     ShirLuchV;    // ---- Ширина Луча в вертикальной плоскости ------
      TFloat     ShirLuchG;    // ---- Ширина Луча в горизонтальной плоскости ------
      TFloat     Lambda;         // ---- Рабочая длинна волны (километры)
      TFloat     OmegaA;   // ---- Угловая скорость вращения анетены -----
      TFloat     FreqFollowImpuls; // ---- Частота следование импульсов -----------
      int        ImpulsCount;         // ---- Колическитво импульсов в пачке ---
      TFloat     Nju_Edit; // -----
