...
public:
    ...
    void    GetChartArray( float T0, int PointOnCahrt, int DrawPointsCount, int ArrayStartPosition, int xOffset, double **xValues, double **yValues);
...
template<class T> void CVector<T>::GetChartArray( float T0, int PointOnCahrt, int DrawPointsCount, int ArrayStartPosition, int xOffset, double **xValues, double **yValues)
{
