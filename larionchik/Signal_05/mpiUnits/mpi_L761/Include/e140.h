...
public:
   ...
   IFC(ULONG) GetArray_DM(USHORT Addr, DWORD Count, PUSHORT Data);
   IFC(ULONG) PutArray_DM(USHORT Addr, DWORD Count, PUSHORT Data);
...
//   IFC(ULONG)  LoadBios(char *FileName);
   ...
   IFC(ULONG)  WriteFlashWord(WORD FlashAddress, WORD Data);
